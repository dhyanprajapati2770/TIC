        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              ...
              symptom checking, disease prediction, and medicine recommendations to help you 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/symptom-checker" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Symptom Checker
                </Link>
              </li>
              <li>
                <Link to="/pharmacy" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Medicine Store
                </Link>
              </li>
              <li>
                <Link to="/chatbot" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Doctor Chat
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">info@healthcarepro.com</span>
              </div>
              <div className="flex items-center space-x-3">
